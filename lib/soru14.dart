...
import 'package:hafta6/soru15.dart';
...
class soru14 extends StatefulWidget {
  @override
  _soru14State createState() => _soru14State();
}
...
class _soru14State extends State<soru14> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      FutureBuilder<LoadData>(
          ...
          builder: (context, snapshot) {
            dogrucevap= snapshot.data.fnlsorular[5]["cevap"];
            if (snapshot.hasData) {
                            ...
                            Padding(
                                ...
                                child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Text(
                                          snapshot.data.fnlsorular[5]["soru"],
                                          style: TextStyle(
                                              fontSize: 21,
                                              fontWeight: FontWeight.bold),
                                          overflow: TextOverflow.ellipsis,

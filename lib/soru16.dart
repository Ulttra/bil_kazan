...
class soru16 extends StatefulWidget {
  @override
  _soru16State createState() => _soru16State();
}
...
class _soru16State extends State<soru16> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      FutureBuilder<LoadData>(
          ...
          builder: (context, snapshot) {
            dogrucevap= snapshot.data.fnlsorular[7]["cevap"];
            if (snapshot.hasData) {
                            ...
                            Padding(
                                ...
                                child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Text(
                                          snapshot.data.fnlsorular[7]["soru"],
                                          style: TextStyle(
                                              fontSize: 21,
                                              fontWeight: FontWeight.bold),
                                          overflow: TextOverflow.ellipsis,

...
import 'package:hafta6/soru14.dart';
...
class soru13 extends StatefulWidget {
  @override
  _soru13State createState() => _soru13State();
}
...
class _soru13State extends State<soru13> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      FutureBuilder<LoadData>(
          ...
          builder: (context, snapshot) {
            dogrucevap= snapshot.data.fnlsorular[4]["cevap"];
            if (snapshot.hasData) {
                            ...
                            Padding(
                                ...
                                child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Text(
                                          snapshot.data.fnlsorular[4]["soru"],
                                          style: TextStyle(
                                              fontSize: 21,
                                              fontWeight: FontWeight.bold),
                                          overflow: TextOverflow.ellipsis,

...
import 'package:hafta6/soru10.dart';
import 'package:hafta6/soru12.dart';
...
class soru11 extends StatefulWidget {
  @override
  _soru11State createState() => _soru11State();
}
...
class _soru11State extends State<soru11> with TickerProviderStateMixin {
  ...
  String adSoyad = '';
  String hakedis = '125000 ₺';
  String odul = '125000 ₺';
  var mydata = [];
  String a;
  String dogrucevap='Aşk';
    ...
    return Scaffold(
      ...
      FutureBuilder<LoadData>(
          ...
          builder: (context, snapshot) {
            dogrucevap= snapshot.data.fnlsorular[2]["cevap"];
            if (snapshot.hasData) {
                            ...
                            Padding(
                                ...
                                child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Text(
                                          snapshot.data.fnlsorular[2]["soru"],
                                          style: TextStyle(
                                              fontSize: 21,
                                              fontWeight: FontWeight.bold),
                                          overflow: TextOverflow.ellipsis,

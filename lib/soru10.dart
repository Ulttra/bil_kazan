...
import 'package:hafta6/soru11.dart';
...
class _soru10State extends State<soru10> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      FutureBuilder<LoadData>(
          ...
          builder: (context, snapshot) {
            dogrucevap= snapshot.data.fnlsorular[1]["cevap"];
            if (snapshot.hasData) {
                            ...
                            Padding(
                                ...
                                child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Text(
                                          snapshot.data.fnlsorular[1]["soru"],
                                          style: TextStyle(
                                              fontSize: 21,
                                              fontWeight: FontWeight.bold),
                                          overflow: TextOverflow.ellipsis,

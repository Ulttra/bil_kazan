...
import 'package:hafta6/soru7.dart';
...
class _soru6State extends State<soru6> {
  ...
  var sorular = [
    {
      'soru': 'Cipslerin taze kalması için paketler hangi gaz ile doldurulur?',
      'cevaplar': ['Oksijen', 'Azot','Hidrojen', 'Helyum'],
      'dogrucevap': 'Azot'
    }
  ];

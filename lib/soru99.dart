...
class soru99 extends StatefulWidget {
  @override
  _soru99State createState() => _soru99State();
}
...
class _soru99State extends State<soru99> with TickerProviderStateMixin {
  ...
  String adSoyad = '';
  String hakedis = '30000 ₺';
  String odul = '30000 ₺';
  var mydata = [];
  String a;
  var sorular = [
    {
      'soru': 'Yukarıdaki logo hangi üniversiteye aittir?',
  'cevaplar': ['KTÜN', 'Selçuk', 'KTÜ', 'Gazi'],
  'dogrucevap': 'Aşk'
    }
  ];
